define(function (require, exports, module) { 
    ...
    var pg_order_grid = $('#pg_order_grid').grid({
        url: '/pg-order/ajax-get-list',
        idField: 'id',
        templateid: 'pg_order_grid_template',
        pagesize: 20,
        scrollLoad: false,
    ...
    $('#search').click(function(){
        pg_order_grid.refresh();
    });

    // 编辑
    $('#pg_order_grid').on('click', '.edit', function(){
        location.href = "/pg-order/edit?id="+$(this).data('id');
    })
    // 删除
    ...
    importExcel('import_orders_btn', '/pg-order/import', null, function() {
        if (agent_grid) {
            agent_grid.refresh();
        }
    })
