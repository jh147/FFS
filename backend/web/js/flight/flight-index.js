define(function (require, exports, module) { 
    ...
    var flight_grid = $('#flight_grid').grid({
        url: '/flight/ajax-get-list',
        idField: 'id',
        templateid: 'flight_grid_template',
        pagesize: 20,
        scrollLoad: false,
    ...
    // 编辑
    $('#flight_grid').on('click', '.edit', function(){
        location.href = "/flight/edit?id="+$(this).data('id');
    });

    // 删除
    $('#flight_grid').on('click', '.btn-del', function(){
