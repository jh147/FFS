 ...
 * you may configure the [[createdByAttribute]], [[modifiedByAttribute]] and [[value]] properties like the following:
 *
 * ```php
 ...
 *             'value' => new OpteratorTimeBehavior('NOW()'),
 *         ],
 *     ];
 * }
 * ```
...
class OpteratorTimeBehavior extends AttributeBehavior
{
    ...
    public function init()
    {
        ...
        if (empty($this->attributes)) {
            $this->attributes = [
                BaseActiveRecord::EVENT_BEFORE_INSERT => [$this->createdByAttribute, $this->modifiedByAttribute],
                BaseActiveRecord::EVENT_BEFORE_UPDATE => $this->modifiedByAttribute,
            ];
        }
    }
