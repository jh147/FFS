...
CREATE TABLE IF NOT EXISTS `shipping_order` (
  ...
  `freight_rates` decimal(14,2) NOT NULL DEFAULT 0 COMMENT '费率（净运价）',
  `freight_fee` decimal(14,2) NOT NULL DEFAULT 0 COMMENT '航空运费',
  `fuel_fee` decimal(14,2) NOT NULL DEFAULT 0 COMMENT '燃油费',
  `freight_total_fee` decimal(14,2) NOT NULL DEFAULT 0 COMMENT '运费总额（含燃油）',
  `pg_quantity` int(4) NOT NULL DEFAULT 0 COMMENT '拉货件数',
  `pg_weight` int(4) NOT NULL DEFAULT 0 COMMENT '拉货重量',
  `pg_freight_rates` decimal(14,2) NOT NULL DEFAULT 0 COMMENT '拉货费率',
  `pg_loss_fee` decimal(14,2) NOT NULL DEFAULT 0 COMMENT '拉货损失金额',
